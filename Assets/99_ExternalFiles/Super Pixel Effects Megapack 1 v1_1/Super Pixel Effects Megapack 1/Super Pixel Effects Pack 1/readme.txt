...
Version 1.2 (11/28/22)
	- Removed some errant green pixels from the PNG sequences and spritesheets of the following animations: fx1_impact_dust_small_brown, fx1_impact_dust_small_gray, and fx1_impact_dust_small_white

Version 1.1 (10/21/22)
	- Fixed some incorrect dates and text strings left over from a previous readme file.

Version 1.0 (10/14/22)
...
Hello! Thank you for downloading the Super Pixel Effects Pack 1 asset pack. Here are a few pointers to help you navigate and make sense of this zip file.
